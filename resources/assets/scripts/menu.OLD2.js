function globalNavDropdowns(e) {
    ...
    this.dropdownRoots.forEach(function(e) {
        ...
        if (e.pointerType == 'touch') return;
        t.startCloseTimeout()
    }), document.body.addEventListener(n.end, function() {
  ...
  function globalNavPopup(e) {
    ...
    this.activeClass = 'globalPopupActive', this.root = document.querySelector(e), this.link = this.root.querySelector('.rootLink'), this.popup = this.root.querySelector('.popup'), this.closeButton = this.root.querySelector('.popupCloseButton'), this.link.addEventListener(n, function(e) {
        ...
        e.stopPropagation()
    }), this.closeButton && this.closeButton.addEventListener(n, function() {
        t.closeAllPopups()
    }), document.body.addEventListener(n, function() {
  ...
  Strut.isRetina = window.devicePixelRatio > 1.3, Strut.mobileViewportWidth = 670, Strut.isMobileViewport = window.innerWidth < Strut.mobileViewportWidth, window.addEventListener('resize', function() {
    ...
    css: function(e, t) {
        var n = document.createElement('link'),
            ...
            i = r[e];
        if (!i) throw new Error('CSS file not found in strut_files config');
    ...
    js: function(e, t) {
        var n = document.createElement('script'),
            r = window.readConfig('strut_files') || {},
            i = r[e];
        if (!i) throw new Error('Javascript file not found in strut_files config');
    ...
    this.container.classList.add('overlayActive'), this.container.classList.add('dropdownActive'), this.activeDropdown = e, this.dropdownRoots.forEach(function(e) {
    ...
    this.dropdownSections.forEach(function(e) {
        e.el.classList.remove('active'), e.el.classList.remove('left'), e.el.classList.remove('right'), e.name == n ? (e.el.classList.add('active'), r = 'right', i = e.content.offsetWidth, s = e.content.offsetHeight) : e.el.classList.add(r)
    });
    var u = 520,
        a = 400,
        f = i / u,
